/* @ts-self-types="./bookclerk_plugin_echo_workerd_rust.d.ts" */
 ...
 * @returns {string}
 */
export function dispatch(method, params_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.dispatch(retptr, ptr0, len0, ptr1, len1);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./bookclerk_plugin_echo_workerd_rust_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bookclerk_plugin_echo_workerd_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
