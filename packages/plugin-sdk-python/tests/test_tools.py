...
def test_format_manifest_emits_sealed_table_binding():
...
def test_env_properties_include_sealed_binding(tmp_path: Path):
    names = [name for name, _, _ in env_properties_for({"id": "echo", "secrets": {}})]
