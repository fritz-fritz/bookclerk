...
| **GUI** | Shared React web UI served by `bookclerkd`; optional Linux tray → browser |
...
| `bookclerk-tray` | Linux StatusNotifier tray → opens web UI in the system browser |
...
development. A Linux tray companion opens that UI in the system browser; an
embedded desktop shell waits on maintained native bindings (see
