...
CONTRACTS = {
    "graphicaudio": {
        "client": ROOT / "crates/libation-graphicaudio/src/client.rs",
        "must_contain": [
        ...
        "magento": ROOT / "crates/libation-graphicaudio/src/magento.rs",
    ...
    "chirp": {
        "client": ROOT / "crates/libation-chirp/src/client.rs",
        "must_contain": [
