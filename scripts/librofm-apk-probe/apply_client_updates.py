#!/usr/bin/env python3
"""Apply APK-probe suggested constants onto crates/bookclerk-plugins/source-libro/src/client.rs.
...
def main(argv: list[str] | None = None) -> int:
    ...
    client_rs = args.repo_root / "crates/bookclerk-plugins/source-libro/src/client.rs"
