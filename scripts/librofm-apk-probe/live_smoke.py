...
def load_client_profile(repo: Path) -> Profile:
    ...
    text = (repo / "crates/bookclerk-plugins/optional/source-libro/src/client.rs").read_text(encoding="utf-8")
    consts: dict[str, str] = {}
    for line in text.splitlines():
        ...
        try:
            ...
            continue
    # Mirror crates/bookclerk-plugins/optional/source-libro/src/client.rs AuthInterceptor-equivalent
...
def main(argv: list[str] | None = None) -> int:
    ...
    if public_wanted:
        if (args.repo_root / "crates/bookclerk-plugins/optional/source-libro/src/client.rs").exists():
