//! The library sync engine: full/delta sync into the per-account database,
//! podcast-episode resolution, and the staleness-driven auto-sync used by
...
use super::DEFAULT_RESPONSE_GROUPS;
...
pub(crate) const SYNC_RESOLUTION_CONCURRENCY: usize = 10;
...
const CATALOG_RESPONSE_GROUPS: &str = "badges,category_ladders,contributors,customer_rights,media,product_attrs,\
