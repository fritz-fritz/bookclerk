...
pub use bookclerk_plugin_abi::v2::{
    ...
    ContentSourceContext, CopyResult, Database, DatabaseClient, DatabaseContext, Destination,
    DestinationClient, DestinationContext, DestinationServer, DomainEvent, EventResult,
