...
pub use bookclerk_plugin_abi::v2::{
    ...
    AdapterDatabaseSession, AdapterSessionHandle, AdapterSessionOpen, ByteRange, Cancellation,
    ...
    DomainEvent, EventResult, GuestDatabase, HealthOk, Integration, IntegrationClient,
