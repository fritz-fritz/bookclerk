...
pub use bookclerk_plugin_abi::v2::{
    ...
    AdapterDatabaseSession, AdapterSessionHandle, AdapterSessionOpen, AdapterTransaction,
    ByteRange, Cancellation, ContentSource, ContentSourceClient, ContentSourceContext, CopyResult,
    Database, DatabaseClient, DatabaseContext, Destination, DestinationClient, DestinationContext,
    DestinationServer, DomainEvent, EventResult, GuestDatabase, HealthOk,
    HostAdapterDatabaseSession, HostAdapterDatabaseSessionClient, Integration, IntegrationClient,
    ...
    OidcClientTemplate, PluginClient, PluginDescribe, PluginRoot, PluginServer, ProgressSink,
    PutResult, QueryPage, ReadResult, ScalarLimits, Source, SourceClient, SourceContext,
    SourceServer, StreamCopyHandler, StreamCopySpec, WorkerContext, WriteOptions, ABI_MAJOR,
    ABI_MINOR, ENVELOPE_VERSION, FEATURE_SCALAR_LIMITS, FEATURE_STORAGE_COPY, FEATURE_STREAMS,
