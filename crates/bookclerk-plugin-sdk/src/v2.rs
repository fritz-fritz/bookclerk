...
pub use bookclerk_plugin_abi::v2::{
    ...
    ContentSourceClient, ContentSourceContext, CopyResult, Database, DatabaseClient,
    DatabaseContext, Destination, DestinationClient, DestinationContext, DestinationServer,
    DomainEvent, EventResult, ExecResult, GuestDatabase, HealthOk, Integration, IntegrationClient,
    ...
    SourceServer, Statement, StreamCopyHandler, StreamCopySpec, WorkerContext, WriteOptions,
    ABI_MAJOR, ABI_MINOR, ENVELOPE_VERSION, FEATURE_SCALAR_LIMITS, FEATURE_STORAGE_COPY,
    FEATURE_STREAMS, MAX_LIST_PAGE, MAX_SCALAR_BYTES, MAX_STREAM_WINDOW_BYTES, PRODUCT_API_VERSION,
};
