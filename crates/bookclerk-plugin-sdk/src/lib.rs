...
pub use bookclerk_plugin_abi::{
    ...
    AdapterBackupOps, AdapterDatabaseSession, AdapterExecuteRequest, ByteRange, Cancellation,
    ContentSource, ContentSourceClient, ContentSourceContext, CopyResult, Database,
    DatabaseAdapterConfig, DatabaseClient, DatabaseContext, DbBootstrap, DbCapabilities, DbColumn,
    DbIdentityHighWater, DbPlanStatementKind, DbResultSelection, DbRow, DbTiming, DbType, DbValue,
    Destination, DestinationClient, DestinationContext, DestinationServer, DiagnoseResult,
    DomainEvent, EventResult, ExecuteReply, ExecuteRequest, GuestDatabase, HealthOk, Integration,
    ...
    PluginError, PluginErrorCode, PluginRoot, PluginServer, ProgressSink, PutResult, QueryPage,
    ReadResult, ScalarLimits, Source, SourceClient, SourceContext, SourceServer, StatementResult,
    StreamCopyHandler, StreamCopySpec, TypedDbStatement, WorkerContext, WriteOptions, ABI_MAJOR,
    ABI_MINOR, DATABASE_ADAPTER_CONFIG_MEDIA_TYPE, ENVELOPE_VERSION, FEATURE_SCALAR_LIMITS,
