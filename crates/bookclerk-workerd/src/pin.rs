...
pub const BUNDLED_WORKERD_COMPAT_DATE: &str = "2026-09-19";

/// GitHub release tag (includes leading `v`).
pub const WORKERD_RELEASE_TAG: &str = "v1.20260919.1";
...
pub fn asset_for_target(os: &str, arch: &str) -> Option<WorkerdAsset> {
    match (os, arch) {
        ("linux", "x86_64") => Some(WorkerdAsset {
            ...
            sha256_hex: "fad578d288d7bd62143bb5d53da43c753617ac167a0f9c87c6dca4d0beae5d41",
        }),
        ("linux", "aarch64") => Some(WorkerdAsset {
            artifact: "workerd-linux-arm64.gz",
            sha256_hex: "865a66fec743a12adb8c35cc768992ae559aed17c5d61ed0e705f8d29e87b8f4",
        }),
        ("macos", "x86_64") => Some(WorkerdAsset {
            artifact: "workerd-darwin-64.gz",
            sha256_hex: "086a111bb46ba58945968bd4a8ecd0c53adcbd4357af314dfab40259ca78b850",
        }),
        ("macos", "aarch64") => Some(WorkerdAsset {
            artifact: "workerd-darwin-arm64.gz",
            sha256_hex: "596b251ae9b79d29c64c97548ec50830ab0ca2e8f1695b093b959ace787318ec",
        }),
        ("windows", "x86_64") => Some(WorkerdAsset {
            artifact: "workerd-windows-64.gz",
            sha256_hex: "f2b35760ee46afd0640ed9e35a3dfb943106dd702fcb4132b848cd3a8a389df6",
        }),
        _ => None,
    }
}
