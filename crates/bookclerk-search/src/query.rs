...
///
/// Handles common shortcuts: `-acquired`, `[tag]`, field synonyms.
#[must_use]
pub fn normalize_lucene_query(input: &str) -> String {
    ...
    // Classic boolean shortcuts on acquired/finished fields.
    for (from, to) in [
...
mod tests {
    ...
    #[test]
    fn negated_acquired_shortcut() {
        assert_eq!(normalize_lucene_query("-acquired"), "acquired:false");
    }
}
