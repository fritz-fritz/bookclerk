...
async fn empty_library_scan_upserts_zero() {
    ...
    let dir = tempfile::tempdir().unwrap();
    libation_chirp::save_auth(
        &libation_chirp::auth_file_for_account(dir.path(), None, "a@ex.com"),
        &libation_chirp::ChirpAuthFile {
...
async fn fetch_via_content_source() {
    ...
    let dir = tempfile::tempdir().unwrap();
    libation_chirp::save_auth(
        &libation_chirp::auth_file_for_account(dir.path(), None, "u@ex.com"),
        &libation_chirp::ChirpAuthFile {
            access_token: "tok".into(),
            web_token: None,
            email: "u@ex.com".into(),
