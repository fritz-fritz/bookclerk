...
pub use migrations::{
    ...
    latest_schema_sqlite, load_plugin_migration_history, min_supported_schema_version,
    next_pending_plugin_migration, pending_plugin_suffix, plugin_apply_statements,
    plugin_history_digest, plugin_history_session_matches, plugin_journal_has_entry,
    plugin_journal_select_request, plugin_migration_checksum,
