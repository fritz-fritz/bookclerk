//! Filesystem / object-store path length limits for acquired storage keys.
//!
...
//! [`S3_MAX_OBJECT_KEY_BYTES`] (1024) UTF-8 bytes. Acquire applies these when
...
/// Limits applied when hardening acquired storage keys.
